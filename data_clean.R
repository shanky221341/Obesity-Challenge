file <- c("http://www.hscic.gov.uk/catalogue/PUB16988/Obes-phys-acti-diet-eng-2015-tab.csv", 
    "http://www.hscic.gov.uk/catalogue/PUB13648/Obes-phys-acti-diet-eng-2014-tab_CSV.csv", 
    ...
    "http://www.hscic.gov.uk/catalogue/PUB00210/obes-phys-acti-diet-eng-2011-tab.xls", 
    "http://www.hscic.gov.uk/catalogue/PUB00206/obes-phys-acti-diet-eng-2010-tab.xls", 
    "http://www.hscic.gov.uk/catalogue/PUB00188/obes-phys-acti-diet-eng-2009-tab.xls", 
    "http://www.hscic.gov.uk/catalogue/PUB00175/obes-phys-acti-diet-eng-2008-tab.xls")
# Check the type of the file for csv or xls Set the screen wide to display all the
# columns
howWide = 150
options(width = howWide)
temp2 <- NULL
regions <- c("E92000001", "E18000001", "E18000002", "E18000003", "E18000004", "E18000005", 
    "E18000006", "E18000007", "E18000008", "E18000009", "E18000010")
regions1 <- c("E92000001", "E18000001", "E18000002", "E18000003", "E18000004", "E18000005", 
    "E18000006", "E18000007", "E18000008", "E18000010")
parsed_final <- NULL
for (file in file) {
    # print(file)
    ...
    if (csv.check == 1) {
        ...
        if (splits[6] == "2015") {
            ...
            data_mod <- subset(data, grepl("E[0-9]+", ons_code), select = c(1, 4, 5, 6, 
                7))
            ...
            indicators <- c("primary_diag_by_region", "prim_diag_by_comm_area", "prim_diag_second_diag_by_region", 
                "prim_diag_second_diag_by_comm_area", "prim_diag_with_bariat_by_region", 
                "primary_diag_with_bariat_by_comm")
            ...
            while (i != nrow(data_mod)) {
                ...
                if (data_mod[i, 1] != "E92000001") {
                  ...
                  ons_code <- temp[, 1]
                  temp <- cbind(ons_code, cbind(from_year, from_month, to_year, to_month, 
                    indicator), temp[, 2:ncol(temp)])
            ...
            # primary-secondary and bariatric Hence the whole rows will be multiple of three
            # Initialize the start and the end of row
            r_start = 1
            r_end = row_num/3
            ...
            parsed <- cbind(ons_code, cbind(from_year, from_month, to_year, to_month, indicator), 
                data_mod[, 2:ncol(data_mod)])
        }
    } else {
        parsed <- NULL
        ...
        for (i in 1:length(sheet.names)) {
            ...
            data_mod <- cbind(ons_code, cbind(from_year, from_month, to_year, to_month, 
                indicator), data_mod[, 1:ncol(data_mod)])
...
# reformatting the final parsed data
